                    ...
                    return (
                        <li className="post-list-item" key={post.slug}>
                            <Link href={`/posts/${post.slug}`} className="post-list-item-link">
                                <PostListIcon />
                                <Text as="span" color="secondary" size="1" className="post-list-item-title">{post.title}</Text>
                                <Text as="span" size="0" color="secondary" family="mono" className="post-list-item-date">{formattedDate}</Text>
                            </Link>
                        </li>
                    )
                })}
