/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 62e7e0042ee7bc59beccda9987f2f12f)
// Runtime types generated with workerd@1.20260409.1 2025-09-02 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./worker");
		durableNamespaces: "GenreObservationCollector";
	}
	interface Env {
		APP_STORE: KVNamespace;
		EMAIL: SendEmail;
		KV_READ_ONLY_CACHE: "false";
		KV_ENABLE_GENRE_OBSERVATION_WRITES: "false";
		KV_ENABLE_LOOKUP_STATUS_WRITES: "false";
		...
		STEAM_TOKEN: string;
		RACING_EMAIL: string;
		RACING_PASSWORD: string;
		LASTFM_API_KEY: string;
		GARAGE61_API_KEY: string;
		STALE_ALERT_EMAIL_TO: string;
		STALE_ALERT_EMAIL_FROM: string;
		MUSIC_BRAINZ_CLIENT_ID: string;
		MUSIC_BRAINZ_CLIENT_SECRET: string;
		GENRE_OBSERVATION_COLLECTOR: DurableObjectNamespace<import("./worker").GenreObservationCollector>;
		PUBLISHED_CONTENT: Fetcher /* arsenal-share */;
		GARAGE61_REFRESH_WORKFLOW: Workflow<Parameters<import("./worker").RefreshGarage61Workflow['run']>[0]['payload']>;
		GOODREADS_REFRESH_WORKFLOW: Workflow<Parameters<import("./worker").RefreshGoodreadsWorkflow['run']>[0]['payload']>;
		LASTFM_REFRESH_WORKFLOW: Workflow<Parameters<import("./worker").RefreshLastFmWorkflow['run']>[0]['payload']>;
		SETLISTFM_REFRESH_WORKFLOW: Workflow<Parameters<import("./worker").RefreshSetlistFmWorkflow['run']>[0]['payload']>;
		STALE_MONITOR_WORKFLOW: Workflow<Parameters<import("./worker").StaleDataMonitorWorkflow['run']>[0]['payload']>;
		GENRE_REVIEW_DIGEST_WORKFLOW: Workflow<Parameters<import("./worker").GenreReviewDigestWorkflow['run']>[0]['payload']>;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "KV_READ_ONLY_CACHE" | "KV_ENABLE_GENRE_OBSERVATION_WRITES" | "KV_ENABLE_LOOKUP_STATUS_WRITES" | "AIRTABLE_TOKEN" | "SPOTIFY_TOKEN" | "SPOTIFY_CLIENT_ID" | "SPOTIFY_CLIENT_SECRET" | "GITHUB_TOKEN" | "STEAM_TOKEN" | "RACING_EMAIL" | "RACING_PASSWORD" | "LASTFM_API_KEY" | "GARAGE61_API_KEY" | "STALE_ALERT_EMAIL_TO" | "STALE_ALERT_EMAIL_FROM" | "MUSIC_BRAINZ_CLIENT_ID" | "MUSIC_BRAINZ_CLIENT_SECRET">> {}
}
